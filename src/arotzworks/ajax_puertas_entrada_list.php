...
$sf->__query = "SELECT * FROM pedidos_entrada where idpedido=".$r->pedido_id." ORDER BY id ASC";
header ("content-type:text/xml");
echo "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
echo "<puertas_entrada>";
...
cerradura_sol=\"".$puerta["cerradura_sol"]."\"
cerradura_nor=\"".$puerta["cerradura_nor"]."\"
bisagra_larga=\"".$puerta["bisagra_larga"]."\"
bisagra_3cortas=\"".$puerta["bisagra_3cortas"]."\"
